    ...
    return (
        <section id="AboutMe" className="about-me-wrapper">
            <div className="about-me box has-background-dark">
                <div className="media">
                    ...
                    <div className="media-content">
                        ...
                        <p className="subtitle is-4 has-text-info about-me-text">Software Test Engineer</p>
                ...
                <p className="about-me-info">To the {isMobile ? "bottom" : "right"}, you can see two of my personal tracker projects - <a href="https://github.com/adeshpande03/github-readme-streak-stats/" target="_blank">Github Streak Stats</a> (top, forked from a public repository), as well as my original <a target="_blank" href="github.com/adeshpande03/leetCode-Points-Graph">Leetcode Experience Tracker</a> (bottom), both of which update in real time!</p>
            ...
            <div className="imgs" data-aos="fade-left" data-aos-delay="2000">
                <img className="streak-img-container" src="https://raw.githubusercontent.com/adeshpande03/github-streak-img/refs/heads/main/img/streak.svg" alt="GitHub Streak" />
